...
await build({
  entryPoints: { app: "src/js/slide-lab.jsx", native: "src/js/slide-lab-native.js", component: "src/js/slide-section-runtime.js", audience: "src/js/slide-studio-audience.jsx", merge: "src/js/slide-merge-lab.jsx", editor: "src/js/slide-merge.jsx" },
