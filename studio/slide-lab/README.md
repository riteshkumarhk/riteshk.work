...
New covers snapshot the active site's background, raised surfaces and text colour tokens, alongside its font roles. Saved covers keep their authored palette across editor theme changes; **Use site colours** applies the current tokens through normal undo/save. Team entries separated by commas or newlines become individual chips. **Upload brand logo**, beside Client, replaces the initials input and supports original-image upload, replacement and removal without stretching.
