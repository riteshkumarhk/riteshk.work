  ...
  (function() {
    ...
    function loadStudio() {
      ...
      __studioLoading = new Promise(function(resolve, reject) {
        ...
        s.src = "/js/admin-studio.js";
        s.async = true;
        s.onload = function() {
          resolve();
        };
        s.onerror = function() {
          __studioLoading = null;
          reject(new Error("studio load failed"));
        };
    ...
    function openStudio() {
      loadStudio().then(function() {
        if (window.__RKStudio) window.__RKStudio.open({ musSilence, musRestore, thDismiss });
      }).catch(function() {
        flash("Couldn’t load the editor — check your connection and try again.");
      });
    }
