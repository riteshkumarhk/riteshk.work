(() => {
  ...
  (function() {
    ...
    let __host = {};
    function musSilence() {
      if (__host.musSilence) __host.musSilence();
    }
    function musRestore() {
      if (__host.musRestore) __host.musRestore();
    }
    function thDismiss(n) {
      if (__host.thDismiss) __host.thDismiss(n);
    }
