...
(function () {
  ...
  function atsRbShow(built, rb) {
    ...
    function dropTarget(e) {
      ...
      if (dragKind === "role") { var er = e.target.closest(".rbz__xp[data-ii], .rbz__edu[data-ii], .rbz__li[data-ii]"); return er && +er.dataset.si === dragFrom[0] ? { el: er, to: +er.dataset.ii } : null; }
  ...
  const TYPE_DEFAULTS = [
    ...
    /* --- Serif display --- */
    { id: "baskerville", name: "Baskerville", note: "Serif \u00b7 editorial", builtin: true,
      display: { family: "Baskervville", stack: '"Baskervville", Georgia, "Times New Roman", serif', src: "google", css: "Baskervville:ital@0;1", weight: 400 },
      text: { family: "Epilogue", stack: '"Epilogue", system-ui, -apple-system, sans-serif', src: "google", css: "Epilogue:wght@300..700" },
    ...
    { id: "garamond", name: "Garamond", note: "Serif \u00b7 old-style", builtin: true,
      display: { family: "EB Garamond", stack: '"EB Garamond", Georgia, "Times New Roman", serif', src: "google", css: "EB+Garamond:ital,wght@0,400..800;1,400..700", weight: 500 },
    ...
    { id: "cardinal", name: "Cardinal", note: "Serif \u00b7 modern", builtin: true,
      display: { family: "Spectral", stack: '"Spectral", Georgia, "Times New Roman", serif', src: "google", css: "Spectral:wght@300;400;500;600", weight: 500 },
      text: { family: "Inter Tight", stack: '"Inter Tight", system-ui, -apple-system, sans-serif', src: "google", css: "Inter+Tight:wght@300..700" },
      mono: { family: "IBM Plex Mono", stack: '"IBM Plex Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "IBM+Plex+Mono:wght@400;500;600" } },

    /* --- Sans-serif display --- */
    { id: "grotesk", name: "Grotesk", note: "Sans \u00b7 modern", builtin: true,
      display: { family: "Space Grotesk", stack: '"Space Grotesk", system-ui, -apple-system, sans-serif', src: "google", css: "Space+Grotesk:wght@400..700", weight: 500 },
    ...
    { id: "archivo", name: "Archivo", note: "Sans \u00b7 grotesque", builtin: true,
      display: { family: "Archivo", stack: '"Archivo", system-ui, -apple-system, sans-serif', src: "google", css: "Archivo:wght@400..800", weight: 600 },
      text: { family: "Libre Franklin", stack: '"Libre Franklin", system-ui, -apple-system, sans-serif', src: "google", css: "Libre+Franklin:wght@300..700" },
      mono: { family: "IBM Plex Mono", stack: '"IBM Plex Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "IBM+Plex+Mono:wght@400;500;600" } },
    { id: "sora", name: "Sora", note: "Sans \u00b7 geometric", builtin: true,
      display: { family: "Sora", stack: '"Sora", system-ui, -apple-system, sans-serif', src: "google", css: "Sora:wght@300..800", weight: 600 },
      text: { family: "Figtree", stack: '"Figtree", system-ui, -apple-system, sans-serif', src: "google", css: "Figtree:wght@300..800" },
      mono: { family: "Geist Mono", stack: '"Geist Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "Geist+Mono:wght@400..700" } },

    /* --- Display faces --- */
    { id: "unbounded", name: "Unbounded", note: "Display \u00b7 rounded", builtin: true,
      display: { family: "Unbounded", stack: '"Unbounded", system-ui, -apple-system, sans-serif', src: "google", css: "Unbounded:wght@400..800", weight: 600 },
      text: { family: "Albert Sans", stack: '"Albert Sans", system-ui, -apple-system, sans-serif', src: "google", css: "Albert+Sans:wght@300..700" },
      mono: { family: "Space Mono", stack: '"Space Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "Space+Mono:wght@400;700" } },
    { id: "syne", name: "Syne", note: "Display \u00b7 geometric", builtin: true,
      display: { family: "Syne", stack: '"Syne", system-ui, -apple-system, sans-serif', src: "google", css: "Syne:wght@400..800", weight: 600 },
      text: { family: "Inter", stack: '"Inter", system-ui, -apple-system, sans-serif', src: "google", css: "Inter:wght@300..700" },
      mono: { family: "JetBrains Mono", stack: '"JetBrains Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "JetBrains+Mono:wght@400..700" } },
    { id: "bricolage", name: "Bricolage", note: "Display \u00b7 contemporary", builtin: true,
      display: { family: "Bricolage Grotesque", stack: '"Bricolage Grotesque", system-ui, -apple-system, sans-serif', src: "google", css: "Bricolage+Grotesque:opsz,wght@12..96,400..800", weight: 600 },
      text: { family: "Work Sans", stack: '"Work Sans", system-ui, -apple-system, sans-serif', src: "google", css: "Work+Sans:wght@300..700" },
      mono: { family: "DM Mono", stack: '"DM Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "DM+Mono:wght@300;400;500" } },

    /* --- Monospace display --- */
    { id: "terminal", name: "Terminal", note: "Mono \u00b7 display", builtin: true,
      display: { family: "Space Mono", stack: '"Space Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "Space+Mono:wght@400;700", weight: 700 },
      text: { family: "Inter", stack: '"Inter", system-ui, -apple-system, sans-serif', src: "google", css: "Inter:wght@300..700" },
      mono: { family: "Space Mono", stack: '"Space Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "Space+Mono:wght@400;700" } },
    { id: "plex", name: "Plex", note: "Mono \u00b7 IBM Plex", builtin: true,
      display: { family: "IBM Plex Mono", stack: '"IBM Plex Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "IBM+Plex+Mono:wght@400;500;600;700", weight: 600 },
      text: { family: "IBM Plex Sans", stack: '"IBM Plex Sans", system-ui, -apple-system, sans-serif', src: "google", css: "IBM+Plex+Sans:wght@300;400;500;600" },
      mono: { family: "IBM Plex Mono", stack: '"IBM Plex Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "IBM+Plex+Mono:wght@400;500;600" } },
    { id: "martian", name: "Martian", note: "Mono \u00b7 technical", builtin: true,
      display: { family: "Martian Mono", stack: '"Martian Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "Martian+Mono:wght@300..700", weight: 600 },
      text: { family: "Hanken Grotesk", stack: '"Hanken Grotesk", system-ui, -apple-system, sans-serif', src: "google", css: "Hanken+Grotesk:wght@300..800" },
      mono: { family: "Martian Mono", stack: '"Martian Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "Martian+Mono:wght@300..700" } },

    /* --- Handwriting display --- */
    { id: "caveat", name: "Caveat", note: "Handwriting \u00b7 flowing", builtin: true,
      display: { family: "Caveat", stack: '"Caveat", "Segoe Script", cursive', src: "google", css: "Caveat:wght@400..700", weight: 600 },
      text: { family: "Inter", stack: '"Inter", system-ui, -apple-system, sans-serif', src: "google", css: "Inter:wght@300..700" },
      mono: { family: "JetBrains Mono", stack: '"JetBrains Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "JetBrains+Mono:wght@400..700" } },
    { id: "kalam", name: "Kalam", note: "Handwriting \u00b7 casual", builtin: true,
      display: { family: "Kalam", stack: '"Kalam", "Segoe Script", cursive', src: "google", css: "Kalam:wght@300;400;700", weight: 400 },
      text: { family: "Mulish", stack: '"Mulish", system-ui, -apple-system, sans-serif', src: "google", css: "Mulish:wght@300..800" },
      mono: { family: "DM Mono", stack: '"DM Mono", ui-monospace, "SF Mono", monospace', src: "google", css: "DM+Mono:wght@300;400;500" } },
  ...
  function ensureTypography(d) {
    ...
    if (!Array.isArray(d.typography.systems) || !d.typography.systems.length) d.typography.systems = typeDefaults();
      ...
      // Merge in any built-in systems added since this content.json was last saved (matched by id) so new
      // presets show up without wiping the user's active pick or their generated systems.
      var have = {}; d.typography.systems.forEach(function (s) { if (s && s.id) have[s.id] = 1; });
      TYPE_DEFAULTS.forEach(function (bi) { if (!have[bi.id]) d.typography.systems.push(JSON.parse(JSON.stringify(bi))); });
    }
  ...
  function typeFaceCss(faces) {
    ...
    return (faces || []).map(function (f) {
      var url = previewSrc(String((f && f.url) || ""));   // resolve an unpublished hosted path to its pending data URI so the studio card renders it before Publish
  ...
  function typeSanRole(r, kind) {
    ...
    if (!fam) return null;
    var src = (r.src === "fontshare") ? "fontshare" : "google";
    var css = String(r.css || "").trim();
    if (!css) css = (src === "fontshare") ? fam.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "") : fam.replace(/\s+/g, "+");
  ...
  async function typeGenerate(btn) {
    ...
    var used = [];
    (data.typography.systems || []).forEach(function (s) { ["display", "text", "mono"].forEach(function (k) { if (s[k] && s[k].family) used.push(s[k].family); }); });
    used = used.filter(function (v, i) { return v && used.indexOf(v) === i; });
  ...
  // Download a system's Google faces (via the worker font-css proxy) + commit them to R2 so it loads locally
  // like the built-ins. Sets sys.faces + marks the roles selfHosted. Throws on failure; the caller persists.
  async function typeHostSys(sys) {
    if (!sys) return false;
    if (!adminSession()) throw new Error("sign in to self-host");
    var roles = [sys.display, sys.text, sys.mono].filter(function (r) { return r && r.src === "google" && r.css && !r.selfHosted; });
    if (!roles.length) return true;   // already local
    ...
    if (!descs.length) throw new Error("no font faces found");
    var faces = [];
    for (var i = 0; i < descs.length; i++) {
      var fd = descs[i];
      status("Self-hosting " + (sys.name || "system") + " \u2014 " + fd.family + " " + fd.weight + " (" + (i + 1) + "/" + descs.length + ")\u2026");
  ...
  function onClick(e) {
    ...
    if (act === "type-remove") {
      ...
      var _rat = _rsys.map(function (s) { return s.id; }).indexOf(_rid);
      if (_rat === -1) return;
      var _rwasActive = data.typography.active === _rid;
      _rsys.splice(_rat, 1);
      if (_rwasActive) data.typography.active = (_rsys.filter(function (s) { return s.builtin; })[0] || _rsys[0] || {}).id || "atelier";
      saveDraft(true);
      if (_rwasActive) apply(true); else previewApply();
      renderBody();
