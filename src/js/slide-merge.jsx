...
function Merger() {
  ...
  function fit() {
    ...
    const zoom = Math.max(.1, Math.min((width - left - right) / 1280, (height - (innerWidth > 900 ? 180 : 112)) / 720, 1));
