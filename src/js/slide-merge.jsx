...
function Merger({ integration, controller }) {
  ...
  const editorBar = <EditorBar historyRef={setHistoryTarget} busy={busy || present !== null || !!deckDialog} editing={editing} onEditing={switchEditing} slideView={slideView} onView={switchView} onPlay={integration?.openPreview || rehearse} canPlay={!!rehearsal.length} newTab={!!integration?.openPreview} />;
