...
test('Prepare budgets and DJ-pad notes, timing, overview and end persist safely', { timeout:90000 }, async () => {
  ...
  try {
    ...
    assert.equal(await page.locator('.merge-layout-toggle').textContent(),'Prepare');
...
test('Rehearse automatically connects and supports fullscreen retry when browser activation is consumed', {timeout:45000}, async () => {
